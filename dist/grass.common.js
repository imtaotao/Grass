...
function createComponentVNode(child, childClass, component) {
  if (childClass.async) {
  ...
  var vnode = new WidgetVNode(component, child, slotVNode, childClass);
  return vnode;
}
      ...
      if (child.type === TAG) {
        if (isReservedTag(child.tagName)) {
          ...
          if (child.tagName === 'slot') {
            ...
            _vnode && pushSlotVNode(vnodeChildren, _vnode);
          }
        } else {
          var childClass = getComponentClass(child, component);
          var _vnode2 = createComponentVNode(child, childClass, component);
          _vnode2 && vnodeChildren.push(_vnode2);
        }
      } else {
